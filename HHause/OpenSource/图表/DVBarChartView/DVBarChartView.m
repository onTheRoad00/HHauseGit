...
- (void)draw {
    ...
    self.xBarView.width = self.xAxisTitleArray.count * (self.barGap + self.barWidth)+self.barGap;
    ...
    self.xBarView.axisColor = [UIColor colorWithRed:53/255.0 green:53/255.0 blue:53/255.0 alpha:1];
    ...
    self.xBarView.barToplableArray = self.barToplableArray;
    
    [self.xBarView draw];
    
    if (self.index >= 0) {
        
        if ((self.index+1) * (self.barGap + self.barWidth)+self.barGap> self.scrollView.width * 1) {
            [self.scrollView setContentOffset:CGPointMake((self.index+1) * (self.barGap + self.barWidth)+self.barGap - self.scrollView.width * 1, 0) animated:YES];
        }else{
...
- (void)commonInit {
    ...
    self.yAxisTextGap = 1;
    self.barGap = 1;
    self.axisColor = [UIColor colorWithRed:102/255.0 green:102/255.0 blue:102/255.0 alpha:1];
    self.textColor = [UIColor colorWithRed:102/255.0 green:102/255.0 blue:102/255.0 alpha:1];
    ...
    self.barColor = [UIColor colorWithRed:134/255.0 green:176/255.0 blue:220/255.0 alpha:1];
    self.barSelectedColor = [UIColor colorWithRed:66/255.0 green:121/255.0 blue:191/255.0 alpha:1];
    self.barWidth = 30;
    self.index = -1;
