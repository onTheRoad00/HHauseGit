...
#define Identifier @"RCArtcleListTableViewCell"

#define categoryString @"?category=30"
@interface RCArtcleListViewController ()<UITableViewDelegate,UITableViewDataSource,XRCarouselViewDelegate,MJRefreshBaseViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;


@end

@implementation RCArtcleListViewController
{
    NSInteger _page;//页
...
{
    RCArtcleListTableViewCell * cell=[tableView dequeueReusableCellWithIdentifier:Identifier forIndexPath:indexPath];
