...
#define LifeIdentifier @"RCArtcleListTableViewCell"

#define categoryString @"?category=20"
@interface RCLifeAbroadViewController ()<UITableViewDelegate,UITableViewDataSource,XRCarouselViewDelegate,MJRefreshBaseViewDelegate>

@property (weak, nonatomic) IBOutlet UITableView *tableView;
@end

@implementation RCLifeAbroadViewController
{
    NSInteger _page;//页
...
- (void)viewDidLoad {
    ...
    _tableView.rowHeight=122*kScreeWidth/375;
...
//    [self imageReplace];
    ...
    UINib * nib=[UINib nibWithNibName:LifeIdentifier bundle:nil];
    [_tableView registerNib:nib forCellReuseIdentifier:LifeIdentifier];
...
{
    RCArtcleListTableViewCell * cell=[tableView dequeueReusableCellWithIdentifier:LifeIdentifier forIndexPath:indexPath];
